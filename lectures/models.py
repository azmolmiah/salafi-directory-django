...
class Lecture(models.Model):
    ...
    date_And_Time = models.DateTimeField(default=datetime.today, help_text='Please, add time difference if behind or takeaway if ahead of server time.')
    expiration_Date_And_Time = models.DateTimeField(default=one_day, help_text='Please, add time difference if behind or takeaway if ahead of server time.')
