...
class Organisation(models.Model):
    ...
    photo_main = models.ImageField(
        upload_to='photos/', default='photos/', help_text='Must be a height of 300px.')
    photo_1 = models.ImageField(
        upload_to='photos/', default='photos/', blank=True)
    ...
    def clean(self):
        if self.logo:
            ...
            if w != 200:
                raise ValidationError(
                    "The logo is %i pixel wide. Must be 200px." % w)
            if h != 200:
                raise ValidationError(
                    "The logo is %i pixel high. Must be 200px." % h)
